...
#define __DEF_QUEUE(__NAME, __TYPE, __PTR_TYPE, __MUTEX_TYPE, __ATOM_ACCESS_WRAP)  \
    ...
    struct __##__NAME##_queue_t {                                   \
        ...
        __TYPE *ptBuffer;                                           \
                                                                    ...
                                                                    \
bool __NAME##_queue_init(__NAME##_queue_t* ptQueue,                 \
...
{                                                                   \
    ...
    return true;                                                    \
                                                                    ...
                                                                    \
bool __NAME##_queue_in(__NAME##_queue_t* ptQueue,                   \
                      const __TYPE *ptObj)                          \
{                                                                   \
    bool bResult = false;                                           \
    __NAME##_queue_t* ptQ = (__NAME##_queue_t*)ptQueue;             \
    ...
    return bResult;                                                 \
                                                                    ...
                                                                    \
bool __NAME##_queue_out(__NAME##_queue_t* ptQueue, __TYPE* ptObj)   \
{                                                                   \
    bool bResult = false;                                           \
    __NAME##_queue_t* ptQ = (__NAME##_queue_t*)ptQueue;             \
    ...
    return bResult;                                                 \
                                                                    ...
                                                                    \
bool __NAME##_queue_is_empty(__NAME##_queue_t* ptQueue)             \
{                                                                   \
    __NAME##_queue_t* ptQ = (__NAME##_queue_t*)ptQueue;             \
    if (ptQ == NULL) {                                              \
        return false;                                               \
...
{                                                                   \
    ...
    return bResult;                                                 \
                                                                    ...
                                                                    \
bool __NAME##_queue_reset_peek(__NAME##_queue_t* ptQueue)           \
{                                                                   \
    bool bResult = false;                                           \
    __NAME##_queue_t* ptQ = (__NAME##_queue_t*)ptQueue;             \
    if (ptQ == NULL) {                                              \
    ...
    return bResult;                                                 \
                                                                    ...
                                                                    \
bool __NAME##_queue_get_all_peeked(__NAME##_queue_t* ptQueue)       \
{                                                                   \
    bool bResult = false;                                           \
    __NAME##_queue_t* ptQ = (__NAME##_queue_t*)ptQueue;             \
    if (ptQ == NULL) {                                              \
